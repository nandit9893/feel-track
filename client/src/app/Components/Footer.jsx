...
const Footer = () => {
  ...
  return (
    <div className="w-full bg-black py-10 lg:px-0 px-5 sm:px-10">
        ...
        <div className="flex flex-col gap-10 w-full">
          <div className="flex sm:flex-row flex-col gap-5 w-full">
            <div className="w-full sm:w-2/5">
              <Image src="/feel-track.png" alt="FeelTrack Logo" width={500} height={500} className="rounded-tl-4xl rounded-br-4xl w-80 md:w-60" priority unoptimized quality={100} />
            </div>
      ...
      <div className="max-w-7xl mx-auto mt-5 flex sm:flex-row flex-col sm:gap-0 gap-3 justify-between items-center">
