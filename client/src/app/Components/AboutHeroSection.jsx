  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative top-0 z-20 flex flex-col items-center justify-center h-full px-6 max-w-4xl mx-auto">
        ...
        <div className="absolute w-28 sm:w-40 md:w-60 lg:w-80 h-28 sm:h-40 md:h-60 lg:h-80 top-[335px] sm:top-72 md:top-60 lg:top-52 flex items-center justify-center">
