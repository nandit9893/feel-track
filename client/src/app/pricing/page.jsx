...
const pricing_plans = [
  {
    name: "Basic",
    price: "20",
    description: "For businesses just getting started and marketing toolds started",
    description_points: [
  ...
  },
  {
    name: "Advanced",
    price: "50",
    description: "For businesses that need advanced features to grow in the market",
    description_points: [
  ...
  },
  {
    name: "Premium",
    price: "80",
    description: "For businesses that need a website and marketing tools",
    description_points: [
      "Everything in Website Launch, plus:",
      "Advanced website features",
      "Unlimited edits",
              ...
              pricing_plans.map((item, index) => (
                <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut", delay: index * 0.5 }}  viewport={{ once: false, amount: 0.2 }} className="w-full p-1 cursor-pointer rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 h-full" key={index}>
                  <div className="bg-white flex flex-col gap-5 p-5 w-full rounded-xl items-center h-full">
                    <p className="bg-gradient-to-r from-purple-500 to-pink-500 text-transparent bg-clip-text text-xl font-semibold">{item.name}</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-6xl font-semibold text-black">{item.price}</p>
                    ...
                    <div className="flex flex-col gap-3 w-full">
                      {
                        item.description_points.map((point, index) => (
                          <div className="flex gap-3 items-center w-full" key={index}>
                            ...
                            <p className="text-sm font-normal text-gray-80">{point}</p>
                          </div>
                        ))
                      }
                    </div>
